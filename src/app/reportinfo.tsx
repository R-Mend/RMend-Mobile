...
export default function ReportInfoScreen(props) {
  const { images, location, details, senderInfo } = props.route.params.report;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        <View style={styles.info}>
          ...
          <Link href="/home/(tabs)/nearby" style={styles.button}>
